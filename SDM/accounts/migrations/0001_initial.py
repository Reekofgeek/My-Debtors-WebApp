# Generated by Django 4.0.6 on 2022-08-11 22:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('SCHOOL', 'School'), ('GUARDIAN', 'Guardian')], default='GUARDIAN', max_length=50, null=True)),
                ...
                ('avatar', models.ImageField(default='Ellipse 1.svg', max_length=255, null=True, upload_to='')),
        ...
        migrations.CreateModel(
            ...
            bases=('accounts.user',),
            managers=[
                ('objects', accounts.models.SchoolManager()),
            ],
        ),
        migrations.CreateModel(
            name='Student',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='accounts.school')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='accounts.guardian')),
            ],
        ),
        migrations.CreateModel(
            name='GuardianChild',
